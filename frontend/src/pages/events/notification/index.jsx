                ...
                {notification.type === "event-request" ? (
                  ...
                  <Toast.Header>
                    <img
                      ...
                      alt=""
                    />
                  <strong className="me-auto">Event: {notification.title}</strong>
                  <small>just now</small>
                  </Toast.Header>
                  <Toast.Body>
                      Date: {notification.date}<br/> 
        ...
        <Toast onClose={() => { onClose(); resetCount(); }} show={isOpen} animation={false}>
          <Toast.Header>
            <img
              ...
              alt=""
            />
            <strong className="me-auto">Notification <Badge pill variant="primary">{count}</Badge></strong>
            <small></small>
          </Toast.Header>
          <Toast.Body style={{ height: "650px", overflow: "scroll"}}>
